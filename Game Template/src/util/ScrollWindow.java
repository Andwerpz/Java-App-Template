...
public abstract class ScrollWindow {
	...
	public void draw(Graphics g) {
		...
		int scrollBarY = (int)((this.height - scrollBarHeight) * ((double)this.offset / (double)(this.realHeight - this.height)));
	...
	//converts the point so that it is relative to the top left corner of this window
